...
dbutils.widgets.text('stage_id', 'curated_accuracy', 'stage_id')
dbutils.widgets.text('notebook_location', './notebooks/5_curated_accuracy/drivers/curated_accuracy_driver', 'notebook_location')
...
if outcome_accuracy != baseline_accuracy:
  exit_message.append(f'WARN: Curated accuracy has changed from {baseline_accuracy} to {outcome_accuracy}.')
